...
function remoteDeviceCall (IPaddr, command) {
  if ((typeof IPaddr == "string") && (typeof command == "string")) { // valid string
    let url = "http://" + IPaddr + "/" + command;
    logger(url, "EXEC");      
    Shelly.call(
      "HTTP.GET",
      {
...
let CONFIG = {
  ...
  scenes: [
    ...
    {
      conditions: {
        address: "60:ef:ab:40:50:16", // moder pri vhodu
...
//        button: 4 // long button press
      ...
      action: function (data) {
        ...
        logger("Scene 1", "EXEC");
        // trigger an action - start Roomba
        remoteDeviceCall("10.38.33.103", "start");
      },
    },
    /** SCENE END 1 **/
    ...
    /** SCENE START 2 **/
    {
      conditions: {
        address: "60:ef:ab:40:50:16", // moder pri vhodu
        button: 2 // 1x short button press
      },
      action: function (data) {
        // Logs a message to the console
        logger("Scene 2", "EXEC");
        // trigger an action - start Roomba
        remoteDeviceCall("10.38.33.103", "dock");
      },
    },
    /** SCENE END 2 **/
    ...
    /** SCENE START 3 **/
    {
      ...
      action: function (data) {
        ...
        logger("Scene 3", "EXEC");
        // trigger an action - start Roomba
        remoteDeviceCall("10.38.33.103", "stop");
      },
    },
    /** SCENE END 3 **/
  ],
